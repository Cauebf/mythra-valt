    ...
    <div className="container mx-auto px-4 py-8">
      <div className="max-w-4xl mx-auto">
        <h1 className="text-3xl font-serif font-bold mb-2">
          Venda suas antiguidades
        </h1>
        <p className="text-muted-foreground mb-8">
          Escolha como deseja vender seus itens de coleção e antiguidades para
          entusiastas de todo o país.
        </p>
        ...
        <div className="grid md:grid-cols-2 gap-6">
          <Card className="group hover:shadow-md transition-all">
            <CardHeader>
              ...
              <CardDescription>
                Anuncie seus itens com preço fixo para venda imediata aos
          ...
          <Card className="group hover:shadow-md transition-all">
            <CardHeader>
              ...
              <CardDescription>
                Crie um leilão para itens raros ou valiosos e deixe os
                compradores competirem pelo melhor lance.
              </CardDescription>
            </CardHeader>
            <CardContent>
              <ul className="space-y-2 text-sm">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <div>
              ...
              <p className="text-sm text-muted-foreground">
                Tire fotos em boa iluminação, mostrando todos os ângulos e
                detalhes do item, incluindo eventuais imperfeições.
              </p>
            </div>
            <div>
              <h3 className="font-medium mb-2">Descrição detalhada</h3>
              <p className="text-sm text-muted-foreground">
                Inclua informações sobre origem, idade, estado de conservação,
                dimensões e qualquer história relevante sobre o item.
              </p>
            </div>
            <div>
              <h3 className="font-medium mb-2">Precificação adequada</h3>
              <p className="text-sm text-muted-foreground">
                Pesquise itens similares para definir um preço justo. Para
                leilões, considere um lance inicial atrativo para gerar
                interesse.
              </p>
            </div>
          </div>
