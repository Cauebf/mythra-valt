    ...
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <p className="text-muted-foreground mb-8">
          Preencha os detalhes do seu item para criar um anúncio atrativo para os compradores.
        </p>
        ...
        <Alert className="mb-8">
          ...
          <AlertDescription>
            Quanto mais detalhes você fornecer, maiores são as chances de vender seu item rapidamente e pelo melhor
            preço.
          </AlertDescription>
        </Alert>
            ...
            <div className="space-y-8">
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>Detalhes essenciais sobre o seu produto</CardDescription>
                </CardHeader>
                <CardContent className="space-y-4">
                  <div>
                    <Label htmlFor="title" className="mb-1">Título do anúncio *</Label>
                    <Input id="title" placeholder="Ex: Relógio de Bolso Vintage Século XIX" required />
                    <p className="text-xs text-muted-foreground mt-1">
                      Seja específico e inclua detalhes importantes como marca, época ou estilo.
                    </p>
                  </div>
              ...
              <Card>
                ...
                <CardContent className="space-y-4">
                  ...
                  <div>
                    <Label htmlFor="history" className="mb-1">História do item</Label>
                    <Textarea
                      id="history"
              ...
              <Card>
                <CardHeader>
                  <CardTitle className="text-2xl">Preço e Disponibilidade</CardTitle>
                  <CardDescription>Defina o valor e a quantidade disponível</CardDescription>
                </CardHeader>
                <CardContent className="space-y-4">
                  <div className="grid md:grid-cols-2 gap-4">
                    <div>
                      <Label htmlFor="price" className="mb-1">Preço (R$) *</Label>
                      <Input id="price" type="number" min="0" step="0.01" placeholder="0,00" required />
                    </div>
                    <div>
                      <Label htmlFor="quantity" className="mb-1">Quantidade disponível *</Label>
                        ...
                        <Tooltip>
                          ...
                          <TooltipContent>
                            <p className="max-w-xs">
                              Você pode oferecer frete grátis para aumentar as chances de venda, ou cobrar pelo envio.
                            </p>
                          </TooltipContent>
                        </Tooltip>
                      </TooltipProvider>
