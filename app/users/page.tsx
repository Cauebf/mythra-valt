    ...
    <div className="container mx-auto px-4 py-8">
      <div className="flex flex-col md:flex-row gap-8">
        ...
        <div className="flex-1">
          {activeTab === "overview" && (
            <div>
                ...
                <Card>
                  ...
                  <CardContent>
                    <div className="flex items-center">
                      ...
                      <span className="text-2xl font-bold">{user.totalPurchases}</span>
                    </div>
                  </CardContent>
                </Card>
                <Card>
                  ...
                  <CardContent>
                    <div className="flex items-center">
                      ...
                      <span className="text-2xl font-bold">{user.totalSales}</span>
                    </div>
                  </CardContent>
                </Card>
                <Card>
                  <CardHeader className="pb-2">
                    <CardTitle className="text-sm font-medium">Total de Leilões</CardTitle>
                  </CardHeader>
                  <CardContent>
                    <div className="flex items-center">
                      <Gavel className="h-5 w-5 text-muted-foreground mr-2" />
                      <span className="text-2xl font-bold">{user.totalAuctions}</span>
                    </div>
                  </CardContent>
                </Card>
              </div>
              ...
              {orders.length > 0 ? (
                    ...
                    <Card key={order.id}>
                      ...
                      <CardFooter>
                        <Button variant="outline" size="sm" asChild>
                          <Link href={`/perfil/pedidos/${order.id}`}>Ver Detalhes</Link>
                        </Button>
                      </CardFooter>
                    </Card>
                  ))}
                ...
                <p className="text-muted-foreground mb-8">Você ainda não realizou nenhum pedido.</p>
              )}
              ...
              {sales.length > 0 ? (
                ...
                <p className="text-muted-foreground mb-8">Você não possui nenhuma venda ativa.</p>
              )}
              ...
              {auctions.length > 0 ? (
                ...
                <p className="text-muted-foreground">Você não possui nenhum leilão ativo.</p>
              )}
            </div>
          )}
          ...
          {activeTab === "orders" && (
            <div>
              <h1 className="text-2xl font-serif font-bold mb-6">Meus Pedidos</h1>
          ...
          {activeTab === "sales" && (
            <div>
              ...
              {sales.length > 0 ? (
                ...
                <p className="text-muted-foreground">Você não possui nenhuma venda ativa.</p>
              )}
            </div>
          )}
          ...
          {activeTab === "reviews" && (
            <div>
              <h1 className="text-2xl font-serif font-bold mb-6">Avaliações Recebidas</h1>
              ...
              {reviews.length > 0 ? (
                      ...
                      <CardHeader>
                        <div className="flex items-start gap-4">
                          ...
                          <div>
                            ...
                            <CardDescription>{new Date(review.date).toLocaleDateString("pt-BR")}</CardDescription>
                ...
                <p className="text-muted-foreground">Você ainda não recebeu nenhuma avaliação.</p>
              )}
            </div>
          )}
          ...
          {activeTab === "favorites" && (
            <div>
              <h1 className="text-2xl font-serif font-bold mb-6">Meus Favoritos</h1>
              ...
              {favorites.length > 0 ? (
                ...
                <p className="text-muted-foreground">Você não adicionou nenhum item aos favoritos.</p>
              )}
            </div>
          )}
          ...
          {activeTab === "settings" && (
            <div>
              <h1 className="text-2xl font-serif font-bold mb-6">Configurações</h1>
